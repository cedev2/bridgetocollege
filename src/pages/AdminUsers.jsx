            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-10">
                    <div className="flex items-center gap-4">
                        <div className="bg-indigo-600 p-2.5 md:p-3 rounded-2xl shadow-lg shadow-indigo-500/20 text-white shrink-0">
                            <Users className="w-6 h-6 md:w-8 md:h-8" />
                        </div>
                        <div>
                            <h1 className="text-xl md:text-3xl font-display font-bold text-slate-900 leading-tight">User Management</h1>
                            <p className="text-xs md:text-base text-slate-500 font-medium">Manage accounts and system access.</p>
                        </div>
                    </div>
                    {successMessage && (
                        <motion.div
                            ...
                            className="w-full md:w-auto bg-emerald-50 text-emerald-700 px-4 py-2.5 rounded-xl border border-emerald-100 flex items-center justify-center md:justify-start gap-2 font-bold text-sm"
                        >
                ...
                <div className="flex flex-col md:flex-row gap-3 md:gap-4 mb-6">
                    <div className="flex-1 relative group">
                        ...
                        <input
                            ...
                            className="w-full pl-12 pr-4 py-3.5 bg-white border border-slate-200 rounded-2xl focus:ring-2 focus:ring-indigo-600 outline-none shadow-sm transition-all text-sm md:text-base"
                            value={searchTerm}
                    ...
                    <div className="flex gap-2 w-full md:w-auto">
                        ...
                        <button onClick={fetchUsers} className="p-3.5 bg-white border border-slate-200 rounded-2xl hover:bg-slate-50 transition-colors text-slate-600 shadow-sm shrink-0">
                            ...
                            >
                                <div className="flex items-center justify-between gap-4 mb-4">
                                    <div className="flex items-center gap-4 min-w-0">
                                        <div className="w-12 h-12 rounded-2xl bg-indigo-50 text-indigo-600 flex items-center justify-center font-bold text-lg border border-indigo-100 shrink-0">
                                            {u.profile_picture ? (
                                                <img src={getImageUrl(u.profile_picture)} alt="" className="w-full h-full object-cover rounded-2xl" />
                                            ) : (
                                                u.full_name?.charAt(0) || 'U'
                                    ...
                                    <span className={`px-2.5 py-1 rounded-lg border text-[9px] font-black uppercase tracking-wider shrink-0 ${getRoleBadgeStyles(u.role)}`}>
                                        {u.role}
                                    </span>
                                </div>
                                <div className="flex items-center justify-between text-xs pt-4 border-t border-slate-50">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <button className="text-indigo-600 font-bold">Details</button>
                                    </div>
                                </div>
                            </div>
                        ))}
                ...
                {selectedUser && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
                        <motion.div
                            ...
                            className="w-full max-w-lg bg-white rounded-3xl md:rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col max-h-[90vh]"
                        >
                            <div className="p-5 md:p-8 border-b border-slate-100 flex items-center justify-between sticky top-0 bg-white/95 backdrop-blur z-20">
                                <h3 className="text-xl md:text-2xl font-bold text-slate-900">User Profile</h3>
                                <button onClick={() => setSelectedUser(null)} className="p-2 md:p-2.5 bg-slate-100 hover:bg-slate-200 rounded-full text-slate-600 transition-colors"><X className="w-5 h-5" /></button>
                            </div>
